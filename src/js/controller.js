...
if (module.hot) module.hot.accept(); // Parcel:Keep the state remains the same and clear the console unless we re-render the page
...
const controlRecipes = async function () {
  try {
    ...
    // 0) Update results view and bookmarks view to mark selected search result
...
const controlSearchResults = async function () {
  try {
    ...
    // resultsView.render(model.state.search.results);// All of the results
